...
var p=i[t].split("=");
if(p[0].toUpperCase()===e.toUpperCase())return p[1];
}
return"";
}
function report(e,a){
...
var i=a.app_info.app_size||0,t=a.app_info.app_name||a.app_info.appname||"",p=a.app_info.apk_url||a.app_info.pkgurl||"",n=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",o=a.app_info.apk_name||a.app_info.pkg_name||"";
...
a.app_info.androiddownurl=p,a.app_info.versioncode=a.app_info.version_code,a.app_info.appinfo_url=a.app_info.appinfo_url,
...
var a=e,i=a.app_info.app_size||0,t=a.app_info.app_name||a.app_info.appname||"",p=a.app_info.apk_url||a.app_info.pkgurl||"",n=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",o=a.app_info.apk_name||a.app_info.pkg_name||"";
i=formSize(i),t=formName(t),a.app_info.app_size=i,a.app_info.app_name=t,a.app_info.apk_name=o,
a.app_info.appname=a.app_info.app_name,a.app_info.app_rating=a.app_info.app_rating||0,
a.app_info.app_id=a.app_info.app_id,a.app_info.icon_url=a.app_info.icon_url,a.app_info.channel_id=a.app_info.channel_id,
a.app_info.md5sum=a.app_info.app_md5,a.app_info.rl=a.rl,a.app_info.pkgname=o,a.app_info.url_scheme=a.app_info.url_scheme,
...
var n={},o=e.is_need_ad,_=e._adInfo;
if(0==o)n=_,n||(n={
advertisement_num:0
});else{
if(a.advertisement_num>0&&a.advertisement_info){
var r=a.advertisement_info;
n.advertisement_info=saveCopy(r);
}
n.advertisement_num=a.advertisement_num;
}
1==o&&(window._adRenderData=n),n=n||{
advertisement_num:0
};
var d=!1;
if(!n.flag&&n.advertisement_num>0){
var s=n.advertisement_num,c=n.advertisement_info;
...
m=u.use_new_protocol)4==u.pos_type?(d=!0,u=i(u),f=u):0==u.pos_type?(u=t(u),(12==u.product_type||19==u.product_type)&&(f=u)):3==u.pos_type&&(u=p(u),
...
var q=u.card_info.card_id||"",D=u.card_info.card_ext||"";
D=D.htmlDecode();
try{
...
var E=u.mp_shop_info.pid||"",z=u.mp_shop_info.outer_id||"";
f={
pid:E,
outer_id:z,
pt:u.pt,
...
var C=u.pos_type;
console.log("appPos",C),function(e,a){
console.log("appPos in",e),JSAPI.invoke("getInstallState",{
packageName:a.app_info.apk_name
},function(i){
var t=i.err_msg;
t.indexOf("get_install_state:yes")>-1&&(a.has_installed=!0,console.log("change btn","js_ad_btn_"+e),
...
var M=document.getElementsByClassName("js_download_app_card")[0],N=M.offsetWidth,P=Math.floor(N/2.875);
P>0&&(M.style.height=P+"px");
}
}else if(3==u.pos_type){
var M=document.createElement("div");
M.appendChild(document.createTextNode(u.image_url)),u.image_url=M.innerHTML.replace(/&amp;/g,"&"),
...
var H=require("a/tpl/cpc_tpl.html.js");
js_cpc_area.innerHTML=TMPL.tmpl(H,{
...
try{
for(var t=JSON.parse(i.replace(/&quot;/g,'"')),p=-1,n=0;n<t.aid_list.length;n++)t.aid_list[n].aid==e.aid&&(p=n);
p>-1&&(a.icon_pos=t.icon_pos||"",a.btn_text=t.btn_text||a.btn_text,a.price=t.aid_list[p].price,
a.sale_text=t.aid_list[p].sale_text,window.__addIdKeyReport("68064",15));
}catch(o){
...
if(js_cpc_area){
var e=(document.documentElement.clientHeight||window.innerHeight)/2,a=js_cpc_area.offsetTop,i=document.getElementById("js_content").offsetHeight;
...
var t=e[i],p=typeof t;
t="string"==p?t.htmlDecode():t,"object"==p&&(t="[object Array]"==Object.prototype.toString.call(t)?saveCopyArr(t):saveCopy(t)),
a.push(t);
}
return a;
}
...
function formName(e){
for(var a=[" ","-","(",":",'"',"'","：","（","—","－","“","‘"],i=-1,t=0,p=a.length;p>t;++t){
var n=a[t],o=e.indexOf(n);
-1!=o&&(-1==i||i>o)&&(i=o);
}
...
var t;
return function(){
var p=this,n=arguments,o=function(){
t=null,i||e.apply(p,n);
},_=i&&!t;
clearTimeout(t),t=setTimeout(o,a),_&&e.apply(p,n);
};
}
...
function ad_click(e,a,i,t,p,n,o,_,r,d,s,c,l,m,f,u,g,y,v){
if(!has_click[p]){
has_click[p]=!0;
var h=document.getElementById("loading_"+p);
...
function i(e,a,i,t,p,o,_,r,d,s,c){
...
a.err_msg&&-1!=a.err_msg.indexOf("ok")||(console.log("http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(e)+"&ticket="+n+"#wechat_redirect"),
location.href="http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(e)+"&ticket="+n+"#wechat_redirect");
}),!1;
...
function t(e,a,i,t,p,n,o,_,r,d){
...
if(has_click[p]=!1,h&&(h.style.display="none"),g.canvas_info)return console.log(" jsapi invoke OpenADCanvas"),
...
if(v)1==g.dest_type?t(a,p,idx,mid,biz,r,_,s,d,c,g):6==g.dest_type?Wxopen_card.openWxopen(c):12==g.product_type||19==g.product_type?i(a,p,idx,mid,biz,r,_,s,d,c,g):0==g.dest_type?location.href=a:(console.info("[APPMSG AD DEBUG] new protocol debug click:",g),
location.href=a);else if("5"==e)location.href="/mp/profile?source=from_ad&tousername="+a+"&ticket="+n+"&uin="+uin+"&key="+key+"&__biz="+biz+"&mid="+mid+"&idx="+idx+"&tid="+p;else{
...
var m="",f="";
c&&(m=c.pkgname&&c.pkgname.replace(/\./g,"_"),f=c.channel_id||""),o={
source:4,
tid:p,
traceid:p,
mid:mid,
...
a=URL.join(a,o),(0==a.indexOf("http://mp.weixin.qq.com/promotion/")||0==a.indexOf("https://mp.weixin.qq.com/promotion/"))&&(a=URL.join(a,{
traceid:p,
aid:_,
engine:s
})),!_&&l&&l(80,a);
...
var t=i.getElementsByClassName("js_ad_link")||[],p=adDatas.ads[a],n=i.getElementsByClassName("js_ad_opt_list_btn_"+e),o=i.getElementsByClassName("js_complain_btn_"+e);
if(p){
for(var _=p.adData,r=p.a_info,d=r.pos_type,s=p.ad_engine,c=0,l=t.length;l>c;++c)!function(e,a){
var i=t[e],p=i.dataset;
if(p&&3!=r.pos_type){
var _=p.type,c=p.url,l=p.rl,m=p.apurl,f=p.tid,u=p.ticket,g=p.group_id,y=p.aid,v=p.pt,h=r.use_new_protocol,w=!0;
(h&&(12==r.product_type||19==r.product_type)||115==v)&&(w=!1,console.log("js dom event type: ",w)),
4==r.pos_type&&(w=!1,console.log("js dom for pos_type:4 event type: ",w)),DomEvent.on(i,"click",function(e){
var i=!!e&&e.target,t=[12,19,23];
if(!i||!i.className||4==d&&a&&-1==t.toString().indexOf(a.product_type)||-1==i.className.indexOf("js_ad_btn")&&-1==i.className.indexOf("js_btn_process")&&-1==i.className.indexOf("js_muted_btn")&&-1==i.className.indexOf("js_poster_cover")&&-1==i.className.indexOf("js_ad_opt_list_btn")&&-1==i.className.indexOf("js_complain_btn")&&-1==i.className.indexOf("js_view_profile")&&-1==i.className.indexOf("js_add_contact")){
if(a){
...
r&&r.has_installed&&("104"==a.pt||"113"==a.pt||"114"==a.pt||"2"==a.pt)?report(114,p):"103"==a.pt||"111"==a.pt||"112"==a.pt?report(23,p):("104"==a.pt||"113"==a.pt||"114"==a.pt)&&report(25,p);
}
var n,o,w,x;
return n=position.getX(i,"js_ad_link")+e.offsetX,o=position.getY(i,"js_ad_link")+e.offsetY,
...
ad_click(_,c,l,m,f,u,g,y,v,d,s,a,n,o,w,x,r,p,h),log("[Ad] ad_click: type="+_+", url="+c+", rl="+l+", apurl="+m+", traceid="+f+", ticket="+u+", group_id="+g+", aid="+y+", pt="+v+", pos_type="+d+", ad_engine="+s),
!1;
}
},w),DomEvent.on(i,"touchstart",function(){
...
}),n[e]&&(console.log("bind btn:",n[e]," for pos type:",r.pos_type," aid:",y),DomEvent.on(n[e],"click",function(){
...
return!1;
})),o[e]&&DomEvent.on(o[e],"click",function(){
