...
for(var e,n=window.location.search.substr(1).split("&"),t=decodeURIComponent(i.rl).split("?")[1].split("&"),r={},a="",c=0;c<n.length;c++){
var p=n[c].split("=");
r[p[0]]=p[1];
}
...
a="biz="+i.__biz+"&click_pos="+i.click_pos+"&pass_ticket="+r.pass_ticket+"&pos_x="+i.pos_x+"&pos_y="+i.pos_y+"&press_interval="+i.press_interval+"&viewid="+l.viewid,
e=window.md5(a),console.log("beforeSign:",a,"signMd5:",e),o.invoke("calRqt",{
rqt:e
},function(i){
var o,n,t;
i.data&&i.k1&&i.k2?(o=encodeURIComponent(i.data),n=i.k1,t=i.k2,s(o,n,t,e,l)):s(0,0,0,e,l);
});
}
var o=i("biz_wap/jsapi/core.js");
