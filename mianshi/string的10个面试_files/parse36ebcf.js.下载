...
if(!l.isShowMpVideo()){
var p;
p=a(j?_:_),p&&B.push(p),"function"==typeof window.__addIdKeyReport&&(window.__addIdKeyReport("28307",10),
...
B.length>0&&"function"==typeof window.__getVideoWh&&k.on(window,"resize",function(){
try{
for(var e=0,t=B.length;t>e;e++){
var i=B[e],n=i.playerObj;
if(n){
...
-1!=b.indexOf("WindowsWechat")||-1==b.indexOf("MicroMessenger")||A.isInMiniProgram||(l=e("appmsg/reward_entry.js"),
l.handle(t.reward,m())),1!=t.reward_entrance_enable_for_preview||A.isIOS||A.isInMiniProgram||(document.getElementById("js_preview_reward")&&(document.getElementById("js_preview_reward").style.display="block"),
...
var t=E.checkNeedAds(),i=t.is_need_ad,n=t.both_ad,r=-1!=location.href.indexOf("mock_ad="),a=-1!=location.href.indexOf("mock");
(r||a)&&(t.is_need_ad=i=1),I("[Appmsg] start get asycn data, is_need_ad:"+i);
var o=0;
y.getData({
biz:biz,
...
e("appmsg/log.js")),E=(e("rt/appmsg/getappmsgext.rt.js"),e("a/a.js")),A=e("biz_wap/utils/mmversion.js"),B=[];
r(),_();
